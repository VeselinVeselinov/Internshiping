...
namespace ToDoListStructure.DataAccess.Dao.Account
{
    class AccountData
    {
        public static List<Entities.Account> Storage;
        public static IDictionary<long, Entities.Account> Data;

        static AccountData()
        {
            Data= new Dictionary<long, Entities.Account>();
			Storage = new List<Entities.Account>()
			{
